...
export default class Collision {
  ...
  checkCollision(objA, objB) {
    ...
    // project points of objA and objB onto objA's normals and check for overlap
    ...
    // project points of objA and objB onto objB's normals and check for overlap
    ...
    // if all overlap, return minimum translation vector
    return this.Result(true, false, this.getMTV(correctionVectors))
  }
}
